...
Java_atu_com_dueroslib_androidsystemimpl_wakeup_WakeUpNative_wakeUpInitial(JNIEnv *env,
                                                                            jobject instance,
                                                                            jstring wakeUpWd_,
                                                                            jstring sFile_,
                                                                            jint mode) {
...
extern "C"
JNIEXPORT jint JNICALL
Java_atu_com_dueroslib_androidsystemimpl_wakeup_WakeUpNative_wakeUpReset(JNIEnv *env,
                                                                          jobject instance) {
    return WakeUpReset();
}
...
extern "C"
JNIEXPORT jint JNICALL
Java_atu_com_dueroslib_androidsystemimpl_wakeup_WakeUpNative_wakeUpDecode(JNIEnv *env,
                                                                           jobject instance,
                                                                           jshortArray data_,
                                                                           jint dataLen,
                                                                           jstring senArr_,
...
extern "C"
JNIEXPORT jint JNICALL
Java_atu_com_dueroslib_androidsystemimpl_wakeup_WakeUpNative_wakeUpFree(JNIEnv *env,
                                                                         jobject instance) {
    LOG_D("WakeUpFree");
    return WakeUpFree();
}