 ...
 */
package atu.com.dueroslib.androidsystemimpl.player;
...
public class MediaPlayerImpl implements IMediaPlayer {
    ...
    public MediaPlayerImpl() {
        ...
        // 读取音量和静音的数据
        currentVolume = (float) MediaPlayerPreferenceUtil.get(DuerOS.ctx,
                KEY_SP_VOLUME, 0.8f);
        isMute = (boolean) MediaPlayerPreferenceUtil.get(DuerOS.ctx,
                KEY_SP_MUTE, false);
        // LinkedList
        ...
        telephonyManager = (TelephonyManager)
                DuerOS.ctx.getSystemService(Service.TELEPHONY_SERVICE);
    ...
    private void playAsset(String resName) {
        ...
        try {
            AssetManager am = DuerOS.ctx.getAssets();
    ...
    public void setVolume(float volume) {
        ...
        //  保存数据
        MediaPlayerPreferenceUtil.put(DuerOS.ctx,
